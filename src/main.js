...
const input = await Actor.getInput() || {
    ...
    location: 'Zürich', // NEU: location als Input
...
// Initiale URL mit page-, publication-date-, sort-by-, location- und category-Input
const baseUrl = 'https://www.jobs.ch';
const searchUrl = `${baseUrl}/en/vacancies/?publication-date=${encodeURIComponent(publicationDate)}&sort-by=${encodeURIComponent(sortBy)}&term=${encodeURIComponent(keyword)}&page=${page}${location ? `&location=${encodeURIComponent(location)}` : ''}${categoryParams}`;
